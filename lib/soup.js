...
module.exports = Soup = (function() {
  ...
  Soup.prototype._select = function(selector) {
    var _$ref, elements, foundElements, lookupAttrName;
    _$ref = this._$ref;
  ...
  Soup.prototype.setAttribute = function(selector, name, _value) {
    var absoluteEnd, absoluteStart, attr, attrDetails, attrGotUpdated, attrString, attributes, element, endInsideOpeningTag, endOfAttributeIndex, j, k, len, len1, newAttrString, openingTagString, quoteType, ref, type, valEnd, valStart, value;
    this._build();
    ref = this._select(selector);
  ...
  Soup.prototype.setInnerHTML = function(selector, _newHTML) {
    var element, j, len, newHTML, oldHTML, ref, type;
    this._build();
  ...
  Soup.prototype._execute = function() {
    var i, j, lastIndex, len, newString, ref, splicing;
